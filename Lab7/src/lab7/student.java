...
public class student extends person{
    ...
    private String localMajor, localFavClass, localGradDate, localPUID;
    
    private Boolean localHogYN;
    
    student(String first, String last, String middle, String street1, String street2, String city, String state, String zip, String country, String birthday, String major, String favoriteClass, String gradDate, Boolean hogYN, String PUID){
    ...
    public void setPUID(String temp){
