...
public class gradStudent extends student {
    ...
    gradStudent(String first, String last, String middle, String street1, String street2, String city, String state, String zip, String country, String birthday, String major, String favoriteClass, String gradDate, Boolean hogYN, String thesisTitle, String advisorFirstName, String advisorLastName){
        super(first, last, middle, street1, street2, city, state, zip, country, birthday, major, favoriteClass, gradDate, hogYN);
